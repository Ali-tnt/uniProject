...
@login_required
def inbox(request):
    conversations = Conversation.objects.filter(members__in=[request.user.id],item__is_deleted=False,item__is_sold=False).distinct()
...
def chat_detail(request, pk):
    ...
    return render(request, 'conversation/chat_detail.html',{
